...
cp -rf /data/projects/dknr-apsystems/package.json /data/package.json
cp -rf /data/projects/dknr-apsystems/data/settings.js /data/settings.js
cp -rf /data/projects/dknr-apsystems/data/.config.projects.json /data/.config.projects.json
cp -rf /data/projects/dknr-apsystems/data/admin.png /data/admin.png
